const DB_NAME = 'BBMCountsCurrentForm';
const STORE_NAME = 'CurrentForm';
...
async function saveCurrentFormData(data) {
    try {
...
export { saveCurrentFormData, getCurrentFormData, clearCurrentForm}