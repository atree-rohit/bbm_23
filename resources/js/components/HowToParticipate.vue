        ...
        <div class="section-card-body">
            ...
            <div class="card-caption p-2">
                ...
                <district-coordinators
                    v-if="show_section == 1 && subsection_id == 1"
                />
            </div>
            <div
                class="card-suggestions border border-primary rounded bg-light"
            >
            ...
            <div
                class="card-links border border-success rounded bg-light"
                v-if="subsection.links"
            >
                <div class="bg-success text-light p-1 h4 m-0">
                    Links and Resources
                </div>
...
export default defineComponent({
                    ...
                    subsections: [
                        {
                            ...
                            links: [
                                ...
                                },
                                {
                                    ...
                                    next_link:
                                        "https://www.inaturalist.org/projects/big-butterfly-month-india-2023",
                                },
                                {
    ...
    computed: {
        current_section() {
            if (this.show_section == -1) return null;
